...
docs/        STRUCTURE.md and STAGED-RUNBOOK.md. DEPLOY.md is the operator entrypoint.
```
...
Vault setup is a one-time durable platform step. The installer follows the IBM order:
Mongo, SLS, JDBC, DRO/BAS, Suite Ready, then Manage.
