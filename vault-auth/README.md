...
|---|---|---|---|
| `mas-gitops` | Argo CD repo-server SA | `openshift-gitops` | Read `secret/<account>/*` |
| `mas-gitops-writer` | `postsync-ibm-sls-update-sm-sa` | `mas-<instance>-sls` | Write instance SLS registration |
