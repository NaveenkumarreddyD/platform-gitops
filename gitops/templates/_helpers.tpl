...
{{- define "gitops.mongoNs"   -}}{{ required "mongo.namespace must be set in gitops/envs/<cluster>/values.yaml and MUST equal MONGO_NS in mas-config-repo/envs/<cluster>.env" .Values.mongo.namespace }}{{- end -}}
